...
- Add a subtle violet glow/sheeen that softly spills onto the surface (gentle light bleed).
- Slightly out of focus if it’s far in the background; if closer, keep it sharp but still subtle.
- Avoid harsh bloom, oversaturated neon blobs, or unrealistic HDR halos.

STRICT:
- DO NOT place the logo on the T-shirt or any clothing.
- DO NOT add any other text, slogans, extra logos, watermarks, or signature marks.
- Do NOT put the logo in the sky, on empty air, or as a floating overlay.
"""
